...
public class XmlService {
  ...
  public XmlService(@Autowired Storage storage,  String bucketName) {
  ...
  /*
   * public void uploadFile(MultipartFile file) throws IllegalStateException,
   * IOException{
   * String buckePath = System.getProperty("user.dir") +
   * "/Backend/microservices/target/bucket/";
